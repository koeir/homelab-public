# iwctl SSID Trouble
The first wifi SSID I tried to connect to had special characters (Ñ and ×) 
that I couldn't type into the terminal
...
I eventually tried redirecting the output of the network scan to a file,
and then editing the file so that only the SSID remained.
